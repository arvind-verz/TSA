...
//    |   |   |   |   |- plugin.min.js
include dirname(dirname(dirname(dirname(__FILE__)))).'/application/config/config.php';
$base_url = 'editor';
	// Get HTTP/HTTPS
...
$access_keys = array(SESS_COOKIE_NAME_ADMIN);
...
$ext_file 	= array('doc', 'docx','rtf', 'pdf', 'xls', 'xlsx', 'csv','fla','ade','adp','mdb','accdb','ppt','pptx','odt','ots','ott','odb','odg','otp','otg','odf','ods','odp','css','ai'); //Files
