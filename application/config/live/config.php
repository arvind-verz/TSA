<?php
  ...
  define('DB_USERNAME' , 'verzcom_svca');

  define('DB_PASSWORD' , 'admin@VWC7');

  define('DB_DATABASE' , 'verzcom_svca');
  
  define('SITE_URL' , 'http://' . $_SERVER['HTTP_HOST'] . '/projects/svca/');  
  
  define('MAIN_SITE_PATH', $_SERVER['DOCUMENT_ROOT'] . '/projects/svca/');
  
  define('ABSOLUTE_PATH', $_SERVER['DOCUMENT_ROOT'] . '/projects/svca/');	 
