...
class Recaptcha
{
    ...
    public function __construct()
    {
		...
		$this->_ci->load->library('all_function');
		
		if($this->_ci->all_function->get_site_options('recaptcha_site_key')!='' && 
		$this->_ci->all_function->get_site_options('recaptcha_secret_key')!='' && 
		$this->_ci->all_function->get_site_options('recaptcha_lang')!=''){
			
			$this->_siteKey = $this->_ci->all_function->get_site_options('recaptcha_site_key');
			$this->_secretKey = $this->_ci->all_function->get_site_options('recaptcha_secret_key');
			$this->_language = $this->_ci->all_function->get_site_options('recaptcha_lang');
    ...
    private function _submitHTTPGet($data)
    {
        ...
        $response = $this->download_page($url);
