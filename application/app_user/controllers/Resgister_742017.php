		...
		if($_POST){
			if ($this->form_validation->run() == FALSE)
			{
				...
				if($seat_limit_status=='N'){
					...
					// Error MSG
					$this->session->set_flashdata('err_msg','Kindly note the complimentary seat for your company has already been taken.');
					redirect(base_url("event-details/".$seo_url));
				}
				if($price!=$ShowPrice){
      ...
      <tr>
            <td align="left" valign="top" style="padding:10px; background:#f5f5f5;  line-height:20px;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tbody>
                ...
                <tr>
                  <td align="left" valign="top" style="font-weight:bold;">Company Name</td>
                  <td align="left" valign="top">:</td>
                  <td align="left" valign="top">'.$details['company_name'].'</td>
                </tr>
                <tr>
                  <td align="left" valign="top" style="font-weight:bold;">Company Type</td>
                  <td align="left" valign="top">:</td>
                  <td align="left" valign="top">'.$details['company_type'].'</td>
                </tr>
                <tr>
                  <td align="left" valign="top" style="font-weight:bold;">Designation</td>
                  <td align="left" valign="top">:</td>
                  <td align="left" valign="top">'.$details['designation'].'</td>
                </tr>
				<tr>
                  <td align="left" valign="top" style="font-weight:bold;">Company Email</td>
                  <td align="left" valign="top">:</td>
