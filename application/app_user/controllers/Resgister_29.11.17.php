...
class Resgister extends MY_Controller {
	...
	function set_event_price_an($event_id,$member_type_id,$member_id){
		$price = 0.00;
		#$istevent_reg = $this->Resgister_model->count_register($member_type_id,$id);
		$istevent_reg = $this->Resgister_model->count_reg_this_company($member_type_id,$event_id,$member_id);
		//echo $this->db->last_query();exit;
		if($istevent_reg==0){
			$price = $this->Resgister_model->get_event_price1($event_id,$member_type_id);
		}else{
			$price = $this->Resgister_model->get_event_price2($event_id,$member_type_id);
		}	
		return $price;	
	}
	...
	function register_form_member($seo_url){
		...
		$istevent_reg = $this->Resgister_model->count_reg_this_company($member_type_id,$event_id,$member_id);
		$price_1 = $this->Resgister_model->get_event_price1($event_id,$member_type_id);
		$price_2 = $this->Resgister_model->get_event_price2($event_id,$member_type_id);
	...
	function resgistration_email($event_reg_id){
		...
		$event=$this->Resgister_model->get_event_details_by_id($event_id);
