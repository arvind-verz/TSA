...
class Resgister extends MY_Controller {
	...
	public function resgistration_email_member($event_reg_id)
	{
			...
			$this->all_function->batch_email_attach($details['company_email'], $auto_from, $auto_from_name,$details['email'], $auto_subject, $body_auto,$fullPathInvoice);
				...
				$this->all_function->batch_email($details['company_email'], $auto_from, $auto_from_name,$details['email'], $auto_subject, $body_auto);
			}
      ...
      <tr>
            <td align="left" valign="top" style="padding:10px; background:#f5f5f5;  line-height:20px;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tbody>
				...
				<tr>
                  <td align="left" valign="top" style="font-weight:bold;">Participent Email</td>
                  <td align="left" valign="top">:</td>
  ...
  <tr>
       ...
       <tr>
            <td align="left" valign="top" style="padding:10px; background:#f5f5f5;  line-height:20px;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tbody>
                <tr>
                  <td width="29%" align="left" valign="top" style="font-weight:bold;">Amount Paid</td>
                  <td width="2%" align="left" valign="top">:</td>
