...
$route['booking-remove'] = "index/booking_remove";
...
$route['our-members'] = "cms/members";
$route['faq'] = "index/faq";
$route['supported-events'] = "events/other_events";
...
$route['register/(:any)'] = "register/register_details/$1";
$route['ajax-promo-code/(:any)'] = "register/ajax_promo_code/$1";

$route['registration-email-paypal/(:any)/(:any)'] = "register/registration_email_paypal/$1/$2";


##
$route['success'] = "cms/success";
$route['cancel'] = "cms/cancel";
$route['membership-types'] = "cms/membership_type";
##

$route['search'] = "index/search";
$route['thank-you/(:any)'] = "thank_you/$1";
$route['thank-you'] = "thank_you/index";
$route['reg-thank-you'] = "thank_you/reg_thank_you";
