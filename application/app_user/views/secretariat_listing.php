                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9 rightpage">
                                	<ol class="breadcrumb">
                                          ...
                                          <li class="active">Secretariat</li>
                                    </ol>
                                    <h3 class="t-header-cnt">
                                    	Secretariat
                                    </h3>
                                    <div class="list-group1 clearfix">
                                       <?php if(count($secretariat)>0){
										   foreach($secretariat as $val)
										   {
										   ?>
                                          <div class="list-group1-item">
                                        	<div class="list-group1-img">
                                             <img src="<?php echo base_url('assets/upload/secretariat/thumb/'.$val['image_name']); ?>" alt=""/>
                                            </div>
