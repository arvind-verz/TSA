                		 ...
                		 <div class="container maincontent">
                            ...
                            <div class="row">
                            	<div class="col-md-6 infocontact">
                                    ...
                                    <strong>Email:</strong> <a href="mailto:<?php echo $this->all_function->get_site_options('contact_email')?>"><?php echo $this->all_function->get_site_options('contact_email')?></a>
                                    </p>
                                    <p>Open from Monday to Friday<br/>Except Public Holidays</p>
                                    ...
                                    <form name="contact" id="contact" method="post" action="<?php echo base_url('contact-us'); ?>">
                                        ...
                                        <div class="item-style4">
                                         ...
                                         <div class="item-style4">
                                            ...
                                            <div class="ipt-style4">
                                            	<input type="text" class="form-control"  name="phone_no" value="<?php echo set_value('phone_no'); ?>"/>
                                            </div>
                                        </div>
                                         <div class="item-style4">
                            ...
                            <div class="box-info-cnt">
                            		<div class="box-des-cnt">
                                    	<h4>Singapore Venture Capital & Private Equity Association complies <br/>
                                complies with <strong>Personal Data Protection Act 2012 (PDPA)</strong> of Singapore</h4> 
                                <p>For requests/ enquiries concerning Personal Data Protection or Privacy Policy please write to the PDPA Officer at <a href="mailto:info@svca.org.sginfo@svca.org.sg">info@svca.org.sg</a>.</p>
                                    </div>
                            </div>
                    </div>
