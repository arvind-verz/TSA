      ...
      <form name="contact" id="contact" method="post" action="<?php echo base_url('resgister/'.$page[0]['seo_url']); ?>">
        <div class="form-style1">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <input type="text" name="last_name" value="<?php echo ($reset) ? "" : set_value('first_name'); ?>" class="form-control" required>
            </div>
          </div>
          <div class="row">
            <div class="col-md-2">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <input type="text" name="email" value="<?php echo ($reset) ? "" : set_value('email'); ?>" class="form-control" required>
            </div>
          </div>
          <div class="row">
            <div class="col-md-2">
