...
<div class="Over_flow">
  ...
  <div class="body_wrap">
    <div class="center"> <img src="<?php echo image('shado_left.png'); ?>" class="shodo_left"> <img src="<?php echo image('shado_right.png'); ?>" class="shodo_right">
      <div class="body">
        <div class="bred_camb"> <a href="<?php echo base_url('/'); ?>" class="home"></a><a href="<?php echo base_url('blog'); ?>" class="diable"><?php echo $page[0]['page_heading'];?></a> </div>
        <div class="listing_wrap">
          <div class="col_left">
            ...
            <div class="left_menu2">
              <ul>
                ...
                <li><a href="<?php echo base_url('blog/'.$val['seo_url']); ?>"><?php echo $val['cat_name'];?></a></li>
                <?php endforeach; ?>
              </ul>
            </div>
            <h2>recent posts</h2>
          ...
          <div class="col_right">
            <h1 class="page_title">Latest Blog</h1>
            <?php if(count($blog)>0){?>
