    ...
    <div class="container maincontent">
      ...
      <div class="list-grid3 clearfix">
        ...
        <div class="list-grid3-info">
          ...
          <div class="group-link-list group-list-grid3 ">
            <div class="clearfix">
      ...
      <div class="list-grid5 clearfix"> <a href="#" class="btn-nav">Navigation</a>
        <div class="mb-tab">
          <ul class="nav nav-tabs" role="tablist">
            ...
            <li role="presentation"><a href="#tab2" aria-controls="PROGRAMME" role="tab" data-toggle="tab">PROGRAMME</a></li>
        ...
        <div class="modal-body">
          ...
          <form name="login" id="login" method="post" action="<?php echo base_url('login'); ?>">
            ...
            <div class="item-login">
              <label class="lb2">Member ID <span class="sys">*</span>:</label>
              <div class="ipt-login">
          ...
          <!--<p style="color: red; margin-bottom: 0;">Please contact with admin to be a member. This event is exclusive for members only.</p>--> 
        </div>
      </div>
    </div>
  </div>
