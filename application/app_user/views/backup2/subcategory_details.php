...
<?php $this->load->view('include/top_subcategory_banner2'); ?>
<div class="wrap-bred">
<div class="container"><div class="bred-camb"><a href="<?php echo base_url('/'); ?>">HOME</a><span class="seprster ">/</span>TOOLS</div>
...
<?php $sub_categories = $this->all_function->get_sub_categories_tools($val['cat_id']);
...
<ul  <?php if(($page[0]['parent_id']==$val['cat_id'])||($page[0]['cat_id']==$val['cat_id'])){echo 'class="selected" style="display:block;"';}else{echo 'style="display:none;"';}?>>
    ...
    <a href="<?php echo base_url('subcategory/'.$val['seo_url']);?>"><?php echo $val['cat_name'];?></a>
    </li>
    <?php }  ?>
</ul>
<?php }  ?>
