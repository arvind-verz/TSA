...
$event_registration_info = $this->Resgister_model->get_event_registration_detail($event_reg_id);
$event_info = $this->Resgister_model->get_event_details_by_id($event_registration_info['event_id']);
