        ...
        <div class="list-grid2-item">
          ...
          <div class="list-grid2-info">
            ...
            <div class="group-link-list clearfix"> 
              ...
              <a href="<?php echo base_url('resgister/'.$val['seo_url']);?>">REGISTER NOW</a>
              <?php }else{?>
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <form name="login" id="login" method="post" action="<?php echo base_url('login'); ?>">
                    ...
                    <div class="item-login"> <a class="btn-login" href="<?php echo base_url('resgister/'.$val['seo_url']);?>">CONTINUE AS NON-MEMBER</a> 
