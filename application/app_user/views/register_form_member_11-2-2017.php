    ...
    <div class="container maincontent">
      ...
      <form name="contact" id="contact" method="post" action="<?php echo base_url('resgister/'.$page[0]['seo_url']); ?>">
        <div class="form-member">
          ...
          <div class="row">
            <div class="col-md-3">
              <label class="lb3">Company Type  :</label>
            </div>
            <div class="col-md-6">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <input type="type" name=""  value="<?php echo $this->session->userdata[USER_LOGIN_PREFIX.'company_email'];?>" disabled class="form-control">
            </div>
          </div>
        </div>
        <hr/>
        ...
        <div class="form-style1">
          ...
          <div class="row">
            <div class="col-md-2">
              <label class="lb3">Attendee's Email Address :</label>
            </div>
            <div class="col-md-6">
              <input type="text" name="email" value="<?php echo ($reset) ? "" : set_value('email'); ?>" class="form-control" >
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <input type="text" name="phone_no" value="<?php echo ($reset) ? "" : set_value('phone_no'); ?>" class="form-control" required>
            </div>
          </div>
          <div class="row">
            <div class="col-md-2">
        ...
        <div class="form-hiden">
          ...
          <div class="form-style1">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <select class="selectpicker" name="payment_type" title="Select One" id='paypal-method' required>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <textarea class="form-control text-1" name="offline_payment" required><?php echo ($reset) ? "" : set_value('offline_payment'); ?></textarea>
              </div>
            </div>
            <?php }?>
