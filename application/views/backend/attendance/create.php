					...
					<?php echo form_open('admin/attendance/schedule_store'); ?>
                            <div class="box-body">
                                <div class="col-lg-12">
                                    ...
                                    ?>
                                                <option value="<?php echo $class->class_code; ?>" data-id="<?php echo $class->class_id; ?>">
                            ...
                            <div class="box-footer">
                                <a href="<?php echo site_url('admin/attendance'); ?>" class="btn btn-default">
                                    <?php echo CANCEL ?>
                                </a>
