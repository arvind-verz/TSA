			...
			<header id="header" class="header">
				<div class="container">
					...
					<?php if($this->session->has_userdata('student_credentials')) { ?>
						<div class="top-user">
							<div class="dropdown">
								<button class="tp-user" type="button" id="Topdropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="jcon-user-1 ileft"></i><?php echo ucfirst($this->session->userdata('student_credentials')['username']); ?></button>
					...
					<?php }else { ?>
						<div class="top-user"> <a href="<?php echo site_url('login'); ?>" class="tp-user"><i class="jcon-user-1 ileft"></i>Login</a> </div>
					<?php } ?>
