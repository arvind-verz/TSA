...
<script>
	$(document).ready(function() {
		$("a.intrest-btn").on("click", function() {
			var ref = $(this);
			var my_values = [];
			$("a.intrest-btn").removeClass("active");
			ref.addClass("active");
			ref.parents("tr").find("td").each(function() {
				my_values.push(decodeHtml($(this).find("a").html()));
			...
			// }
			//console.log(my_values);
			$("textarea#message").val('Hi, I\'m intrested in ' + my_values.join(', '));
		});
