          ...
          <form method="post" action="" name="cms" id="update_form" enctype="multipart/form-data">
            <div class="form_default">
              ...
              <p>
                ...
                <input type="text" name="longitude" required id="longitude" value="<?php echo set_value('longitude'); ?>" class="sf" />
              </p>
              
              <p>
                <label for="office_name" >Latitude  : <span>*</span></label>
                <input type="text" name="latitude" required id="latitude" value="<?php echo set_value('latitude'); ?>" class="sf" />
              </p>
              
              <p>
                <label for="office_name" >Zoom  : <span>*</span></label>
                <input type="text" name="zoom" required id="zoom" value="<?php echo set_value('zoom'); ?>" class="sf" />
              </p>
