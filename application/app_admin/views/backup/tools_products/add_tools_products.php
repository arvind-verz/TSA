      ...
      <div class="From_wrap">
        ...
        <form method="post" action="" name="product" id="update_form" enctype="multipart/form-data">
          <div class="form_default">
            ...
            <div class="body">
              <textarea name="product_short_description" id="bodyContent"><?php echo set_value('product_short_description'); ?></textarea>
            </div>
            </p>
            <p>
              <label for="product_specifications">About The Product: <span>*</span></label>
            <div class="body">
              <textarea name="about_product" id="bodyContent2"><?php echo set_value('about_product'); ?></textarea>
            </div>
            </p>
            ...
            <div class="body">
              <textarea name="standard_equipment" id="bodyContent2"><?php echo set_value('standard_equipment'); ?></textarea>
            </div>
            </p>
            ...
            <div class="body">
              <textarea name="it" id="bodyContent2"><?php echo set_value('it'); ?></textarea>
            </div>
            </p>
            ...
            <div class="body">
              <textarea name="specification" id="bodyContent2"><?php echo set_value('specification'); ?></textarea>
            </div>
            </p>
            ...
            <div class="body">
              <textarea name="spare_parts" id="bodyContent2"><?php echo set_value('spare_parts'); ?></textarea>
            </div>
            </p>
            <p>
              <label for="location">Featured Product : </label>
              <input type="checkbox" name="featured_product" id="featured_product" value="Y">
            </p>
