  ...
  <div class="gridMainbodyDiv">
    ...
    <div class="MainDiv">
      <div class="leftPanel">
        ...
        <div class="From_wrap">
          <form method="post" action="<?php echo base_url('import-tool-products'); ?>" name="product" id="update_form" enctype="multipart/form-data">
        ...
        <h1 class="pageTitle">Manage Products<a href="<?php echo base_url('export-tool-products'); ?>" class="button"><span >Export Product</span> </a><a href="<?php echo base_url('add-tools-products'); ?>" class="button"><span style="margin-right:10px;">Add Product</span> </a></h1>
        <?php $this->load->view('include/message'); ?>
        <?php echo $pagi; ?>
        <form id="frm_display" method="post" action="<?php echo base_url('manage-tools-products'); ?>" >
          <table width="100%" cellspacing="0" cellpadding="0" id="diagnosis_list">
            ...
            <tr>
              ...
              <td align="center">
              <?php if (file_exists(ABSOLUTE_PATH.'assets/upload/tools_products/thumb/'.$val['image_name']) && $val['image_name']!='') {?>
                <img src="<?php echo get_site_image('upload/tools_products/thumb').$val['image_name']; ?>" width="30" />
                <?php }?>
              </td>
              ...
              <td><?php $arr=array();
						...
						if($val['parent_id']!=0)
						{
						   $row=$this->all_function->get_tools_category_name_row($val['parent_id']);
						   if($row['parent_id']!=0)
						   {
							 $row2=$this->all_function->get_tools_category_name_row($row['parent_id']); 
							 $arr[]=$row2['cat_name']; 
						   }else{
								$arr[]=$row['cat_name']; 
						   }
                  ...
                  <td><a class="buttonred" href="manage-video/<?php echo $val['id'] ?>">Manage Video</a></td>
              ...
              <td align="center"><a href="<?php echo base_url('edit-tools-products/'.$val['id']); ?>"><img src="<?php echo image('icons/small/black/edit.png'); ?>"  alt="Edit" title="Edit"></a> <a href="<?php echo base_url('del-tools-products/'.$val['id']); ?>" onClick="return confirm('Are you sure want to delete.');"><img src="<?php echo image('icons/small/black/delete.png'); ?>"  alt="Delete" title="Delete"></a></td>
            </tr>
