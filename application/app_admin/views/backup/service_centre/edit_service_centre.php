...
<div id="MainDiv" class="outer">
  ...
  <ul class="breadcrumb">
       ...
       <li><a href="<?php echo base_url('manage-service-centre'); ?>">Service Centres Management</a></li>
        <li>Edit Service Centres</li>
    </ul>
  <div class="gridMainbodyDiv"> 
    <?php $this->load->view('include/leftmenu'); ?>
    <div class="MainDiv">
      <div class="leftPanel">
        <h1 class="pageTitle">Edit Service Centres</h1>
        <div class="From_wrap">
          ...
          <form method="post" action="" name="cms" id="update_form" enctype="multipart/form-data">
            <div class="form_default">
              ...
              <p>
              <label for="product_specifications">Address : <span>*</span></label>
            <div class="body">
              <textarea name="address" id="bodyContent"><?php echo $details[0]['address'];?></textarea>
            </div>
            </p>
