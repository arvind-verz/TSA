...
<div id="MainDiv" class="outer">
  ...
  <ul class="breadcrumb">
        ...
        <li><a>Enquiries</a></li>
        <li>Accessories Enquiries</li>
  </ul>
  <div class="gridMainbodyDiv"> 
    <?php $this->load->view('include/leftmenu'); ?>
    <div class="MainDiv">
        <div class="leftPanel">
          <h1 class="pageTitle">Manage Accessories Enquiries<a href="<?php echo base_url('export-acc-contact'); ?>" class="button"><span>Export Contacts</span> </a></h1>
          <?php $this->load->view('include/message'); ?>
          <?php echo $pagi; ?>
          <form id="frm_display" method="post" action="<?php echo base_url('manage-acc-contact'); ?>" >
            <table width="100%" cellspacing="0" cellpadding="0">
              ...
              <tr <?php if($val['status']=='N'){echo 'class="unread"';}?>>
                ...
                <td align="center"><a href="view-acc-contact/<?php echo $val['id'] ?>"> <img src="<?php echo image('icons/small/black/search.png'); ?>" alt="View" title="View"></a> &nbsp; <a onClick="return confirm('Are you sure want to delete.');" href="del-acc-contact/<?php echo $val['id'] ?>"> <img src="<?php echo image('icons/small/black/delete.png'); ?>" alt="Delete" title="Delete"></a></td>
              </tr>
