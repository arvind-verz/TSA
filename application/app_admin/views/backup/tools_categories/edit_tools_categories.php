          ...
          <div class="From_wrap">
            ...
            <form method="post" action="" name="banner" id="update_form" enctype="multipart/form-data">
              <div class="form_default">
                ...
                <br/>
                <?php $file = MAIN_SITE_AB_UPLOAD_PATH.'tools_categories/banner/thumb/'.$details[0]['image_banner'];
				  if(is_file($file)){
				 ?>
                <p><img src="<?php echo get_site_image('upload/tools_categories/banner/thumb').$details[0]['image_banner']; ?>" width="200" /></p>
                <?php } ?>
                <p>
                  <span id="catimg" style="display:<?=($details[0]['parent_id']==0)?'none':'block'?>;">
