...
<div id="MainDiv" class="outer">
  ...
  <div class="gridMainbodyDiv"> 
    ...
    <div class="MainDiv">
        <div class="leftPanel">
          <h1 class="pageTitle">Manage Information <a class="button" href="<?php echo base_url('add-information'); ?>"><span>Create New</span></a> </h1>
          <?php $this->load->view('include/message'); ?>
          <?php echo $pagi; ?>
          <form id="frm_display" method="post" action="<?php echo base_url('manage-information'); ?>" >
            <table width="100%" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td><?php echo $start_count; ?></td>
                 <td> <?php if (file_exists(ABSOLUTE_PATH.'assets/upload/information/thumb/'.$val['image_name']) && $val['image_name']!='') {?>
                <img src="<?php echo get_site_image('upload/information/thumb').$val['image_name']; ?>" width="30" />
                <?php }?></td>
                ...
                <td align="center"><?php if($val['status']=='N'){?>
                  ...
                  <?php }?></td>
                <td align="center"><a href="<?php echo base_url('edit-information/'.$val['id']); ?>"><img src="<?php echo image('icons/small/black/edit.png'); ?>"  alt="Edit" title="Edit"></a>
                
                &nbsp;  &nbsp; <a href="<?php echo base_url('del-information/'.$val['id']); ?>" onClick="return confirm('Are you sure want to delete?');"><img src="<?php echo image('icons/small/black/delete.png'); ?>"  alt="Delete" title="Delete"></a>
