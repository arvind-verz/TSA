...
<div id="MainDiv" class="outer">
  ...
  <div class="gridMainbodyDiv"> 
    ...
    <div class="MainDiv">
      <div class="leftPanel">
        <h1 class="pageTitle">Edit Information</h1>
        <div class="From_wrap">
          ...
          <form method="post" action="" name="cms" id="update_form" enctype="multipart/form-data">
            <div class="form_default">
             ...
             <p>
                ...
                <?php if (file_exists(ABSOLUTE_PATH.'assets/upload/information/thumb/'.$details[0]['image_name']) && $details[0]['image_name']!='') {?>
                <p><img src="<?php echo get_site_image('upload/information/thumb').$details[0]['image_name']; ?>" width="200" /></p>
            <?php }?>
            ...
            <?php if (file_exists(ABSOLUTE_PATH.'assets/upload/information/banner/thumb/'.$details[0]['image_banner']) && $details[0]['image_banner']!='') {?>
                <p><img src="<?php echo get_site_image('upload/information/banner/thumb').$details[0]['image_banner']; ?>" width="200"  /></p>
            <?php }?>
