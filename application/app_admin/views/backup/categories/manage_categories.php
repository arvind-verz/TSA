...
<div id="MainDiv" class="outer">
  ...
  <div class="gridMainbodyDiv"> 
    ...
    <div class="MainDiv">
        <div class="leftPanel">
          <h1 class="pageTitle">Manage Accessories Categories <a href="<?php echo base_url('add-categories'); ?>" class="button"><span>Add New</span> </a></h1>
          <?php $this->load->view('include/message'); ?>
          <?php echo $pagi; ?>
          <form id="frm_display" method="post" action="<?php echo base_url('manage-categories'); ?>" >
            <table width="100%" cellspacing="0" cellpadding="0" id="diagnosis_list">
              ...
              <tr>
                ...
                <td><?php echo $parent_category =  $this->all_function->get_parent_category($val['parent_id']);?></td>
                ...
                <td align="center"><a href="edit-categories/<?php echo $val['cat_id'] ?>"><img src="<?php echo image('icons/small/black/edit.png'); ?>"  alt="Edit" title="Edit"></a> <a href="del-categories/<?php echo $val['cat_id'] ?>" onClick="return confirm('Are you sure want to delete.');"><img src="<?php echo image('icons/small/black/delete.png'); ?>"  alt="Delete" title="Delete"></a></td>
              </tr>
