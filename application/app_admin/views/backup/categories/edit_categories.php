...
<div id="MainDiv" class="outer">
  ...
  <div class="gridMainbodyDiv"> 
    ...
    <div class="MainDiv">
        <div class="leftPanel">
          <h1 class="pageTitle">Edit Accessories Category</h1>
          <div class="From_wrap">
            ...
            <form method="post" action="" name="banner" id="update_form" enctype="multipart/form-data">
              <div class="form_default">
                <p>
                  ...
                  <input type="text" name="cat_name" required id="cat_name" value="<?php echo $details[0]['cat_name'];?>" class="sf" />
                </p>
                <p>
                ...
                <p>
                  ...
                  <select name="parent_id" class="sf" id="parent_id">
                    ...
                    <option value="<?php echo $val['cat_id'];?>" <?php if($details[0]['parent_id']==$val['cat_id']){echo 'selected';}?>><?php echo $val['cat_name'];?></option>
                ...
                <br/>
                <?php $file = MAIN_SITE_AB_UPLOAD_PATH.'categories/banner/thumb/'.$details[0]['image_banner'];
				  if(is_file($file)){
				 ?>
                <p><img src="<?php echo get_site_image('upload/categories/banner/thumb').$details[0]['image_banner']; ?>" width="200" /></p>
                <?php } ?>
                <p><span id="catimg" style="display:<?=($details[0]['parent_id']==0)?'none':'block'?>;">
                  <label for="location">Banner (1400 X 251): <span>*</span> </label>
                  <input type="file" name="image_banner" id="image_banner" value="<?php echo $details[0]['image_banner'];?>">
                  </span>
                  <input type="hidden" name="old_image_banner" id="old_image_banner" value="<?php echo $details[0]['image_banner'];?>">
                </p>
                <p>
                <span id="catimg2" style="display:<?=($details[0]['parent_id']==0)?'none':'block'?>;">
                ...
                <p>
                  ...
                  <label for="status" style="text-align:left;">Enable
                    <input type="radio" name="status" required value="Y" <?php if($details[0]['status']=='Y'){ echo 'checked="checked"';}?>>
                  </label>
                  <label for="status" style="text-align:left;">Disable
                    <input type="radio" name="status" required value="N" <?php if($details[0]['status']=='N'){ echo 'checked="checked"';}?>>
                  </label>
                </p>
                <div class="clear"></div>
                <h3>SEO Details</h3>
