...
<div id="MainDiv" class="outer">
  ...
  <ul class="breadcrumb">
        ...
        <li>Edit Secretariat</li>
    </ul>
  <div class="gridMainbodyDiv"> 
    <?php $this->load->view('include/leftmenu'); ?>
    <div class="MainDiv">
      <div class="leftPanel">
        <h1 class="pageTitle">Edit Secretariat</h1>
        <div class="From_wrap">
          ...
          <form method="post" action="" name="cms" id="update_form" enctype="multipart/form-data">
            <div class="form_default">
              ...
              <p>
                ...
                <?php if (file_exists(ABSOLUTE_PATH.'assets/upload/secretariat/thumb/'.$details[0]['image_name']) && $details[0]['image_name']!='') {?>
                <p><img src="<?php echo get_site_image('upload/secretariat/thumb').$details[0]['image_name']; ?>" width="150" /></p>
            <?php }?>
