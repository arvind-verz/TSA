...
<div id="MainDiv" class="outer">
  ...
  <div class="gridMainbodyDiv"> 
    ...
    <div class="MainDiv">
        <div class="leftPanel">
          <h1 class="pageTitle">Edit Event Registration <?php if($details['invoice']!='' && file_exists(ABSOLUTE_PATH.$details['invoice'])){?><a href="<?php echo SITE_URL.$details['invoice'];?>" class="button" target="_blank"><span>Invoice</span> </a><?php }?></h1>
          <div class="From_wrap">
          ...
          <?php $booking_status = $details['booking_status'];?>
          
      <?php if($booking_status!='R'){ ?>
          <p>
                
                <label for="status">Booking Status : <span>*</span></label>
                <?php if($details['payment_type']=='Paypal' && $details['is_paid']=='Pending'){?>
                <label for="status" style="text-align:left;">Rejected
                  <input type="radio" name="booking_status" value="R" <?php if($booking_status=='R'){ echo 'checked="checked"';}?>>
                </label>
                <?php }else{?>
                <label for="status" style="text-align:left;">Approved
                  <input type="radio" name="booking_status" value="Y" <?php if($booking_status=='Y'){ echo 'checked="checked"';}?>>
                </label>
                <label for="status" style="text-align:left;">Rejected
                  <input type="radio" name="booking_status" value="R" <?php if($booking_status=='R'){ echo 'checked="checked"';}?>>
                </label>
              ...
              <?php if($details['payment_type']=='Offline'){?>
              <p>
                <?php $is_paid = $details['is_paid'];?>
                <label for="status">Payment Status : <span>*</span></label>
                <label for="status" style="text-align:left;">Paid
                  <input type="radio" name="is_paid" value="Paid" <?php if($is_paid=='Paid'){ echo 'checked="checked"';}?>>
                </label>
                <label for="status" style="text-align:left;">Pending
                  <input type="radio" name="is_paid" value="Pending" <?php if($is_paid=='Pending'){ echo 'checked="checked"';}?>>
                </label>
              </p>
              <div class="clear"></div>
              <?php }?>
       ...
       <?php }else{?>
       			<!--<p>
                    <label for="status">Booking Status : </label>Rejected
                </p>-->
       <?php }?>
