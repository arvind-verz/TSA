...
<div id="MainDiv" class="outer">
  ...
  <ul class="breadcrumb">
        ...
        <li><a>News</a></li>
        <li><a href="<?php echo base_url('manage-latestnews'); ?>">Latestnews</a></li>
        <li>Manage Latestnews</li>
  </ul>
  <div class="gridMainbodyDiv"> 
    <?php $this->load->view('include/leftmenu'); ?>
    <div class="MainDiv">
        <div class="leftPanel">
          <h1 class="pageTitle">Manage Latestnews <a href="<?php echo base_url('add-latestnews'); ?>" class="button"><span>Add New</span> </a></h1>
          <?php $this->load->view('include/message'); ?>
          <?php echo $pagi; ?>
          <form id="frm_display" method="post" action="<?php echo base_url('manage-latestnews'); ?>" >
            ...
            <thead>
              ...
              <tr>
                ...
                <td align="center"><a href="edit-latestnews/<?php echo $val['id'] ?>"><img src="<?php echo image('icons/small/black/edit.png'); ?>"  alt="Edit" title="Edit"></a> <a href="del-latestnews/<?php echo $val['id'] ?>" onClick="return confirm('Are you sure want to delete.');"><img src="<?php echo image('icons/small/black/delete.png'); ?>"  alt="Delete" title="Delete"></a></td>
              </tr>
