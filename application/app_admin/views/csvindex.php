...
<head>  
<meta charset="utf-8">  
<title>Programmers Arena Adddress Book Project</title> 
...
<div class="navbar navbar-inverse navbar-fixed-top">
 ...
 <a class="brand" href="#">Programmersarena Address book</a>
...
<?php if (isset($error)): ?>
 ...
 <?php endif; ?>
 <?php if (set_value('success') == TRUE): ?>
 <div class="alert alert-success"><?php echo set_value('success'); ?></div>
 <?php endif; ?>

<h2>CI categories Import</h2>
...
<br><br>
 ...
 <td><?php echo $row['cat_seo_name']; ?></td>
 <td><?php echo $row['cat_seo_title']; ?></td>
 <td><?php echo $row['cat_seo_keyword']; ?></td>
 </tr>
 <?php endforeach; ?>
 <?php endif; ?>
 </tbody>
