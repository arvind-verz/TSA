...
<div id="MainDiv" class="outer">
  ...
  <div class="gridMainbodyDiv"> 
    ...
    <div class="MainDiv">
        <div class="leftPanel">
          <h1 class="pageTitle">Edit Newsletter</h1>
          <div class="From_wrap">
            ...
            <form method="post" action="" name="banner" id="update_form" enctype="multipart/form-data">
              <div class="form_default">
                ...
                <div class="body">
                  <textarea name="description" required id="bodyContent"><?php echo $details[0]['description'];?></textarea>
                </div>
                <p>
                ...
                <p><img src="<?php echo get_site_image('upload/newsletter/thumb').$details[0]['image_name']; ?>" width="100" /></p>
                <p>
                  <label for="image_name">Image (248 X 146) : <span>*</span></label>
                  <input type="file"  name="image_name" id="image_name">
                  <input type="hidden" name="image_name_old" value="<?=$details[0]['image_name']?>">
                </p>
                <?php if($details[0]['image_banner']!=''){ ?>
                <p><img src="<?php echo get_site_image('upload/newsletter/banner/thumb').$details[0]['image_banner']; ?>" width="200" /></p>
                <?php } ?>
                <p>
