      ...
      <div class="From_wrap">
        ...
        <form method="post" action="" name="product" id="update_form" enctype="multipart/form-data">
          <div class="form_default">
            ...
            <p>
              <label for="location">Banner Image (1400 x 350) : <span>*</span></label>
              <input type="file" name="image_banner" required id="image_banner">
            </p>
             <p>
              <label for="name">Registration End Date : <span>*</span></label>
              <input type="text" name="registration_date" required id="registration_date" value="<?php echo set_value('registration_date'); ?>" class="sf" />
            </p>
             <p>
              <label for="name">Event Start Date : <span>*</span></label>
              <input type="text" name="start_date" required id="start_date1" value="<?php echo set_value('start_date'); ?>" class="sf" />
            </p>
            
            <p>
              <label for="name">Event End Date : <span>*</span></label>
              <input type="text" name="end_date" required id="end_date1" value="<?php echo set_value('end_date'); ?>" class="sf" />
            </p>
            
            <p>
              <label for="name">Last Payment Date : <span>*</span></label>
              <input type="text" name="last_payment_date"  id="last_payment_date" value="<?php echo set_value('last_payment_date'); ?>" class="sf" required />
            </p>
