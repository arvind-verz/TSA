...
<div id="MainDiv" class="outer">
  ...
  <ul class="breadcrumb">
        ...
        <li>Add Committee Member</li>
    </ul>
  <div class="gridMainbodyDiv"> 
    <?php $this->load->view('include/leftmenu'); ?>
    <div class="MainDiv">
      <div class="leftPanel">
        <h1 class="pageTitle">Add Committee Member</h1>
        <div class="From_wrap">
          ...
          <form method="post" action="" name="cms" id="update_form" enctype="multipart/form-data">
            <div class="form_default">
              ...
              <select name="cat_id" class="sf" required>
                ...
                <option value="<?php echo $val['id'];?>" <?php if(set_value('cat_id')==$val['id']){echo 'selected';} ?>><?php echo $val['name'];?></option>
                <?php endforeach; ?>
              </select>
            </p>
