...
<div id="MainDiv" class="outer">
  ...
  <ul class="breadcrumb">
        ...
        <li>Manage Committee Category</li>
    </ul>
  <div class="gridMainbodyDiv"> 
    <?php $this->load->view('include/leftmenu'); ?>
    <div class="MainDiv">
        <div class="leftPanel">
          <h1 class="pageTitle">Manage Committee Category <a class="button" href="<?php echo base_url('add-committee-categtory'); ?>"><span>Create New</span></a> </h1>
          <?php $this->load->view('include/message'); ?>
          <?php echo $pagi; ?>
          <form id="frm_display" method="post" action="<?php echo base_url('manage-committee-categtory'); ?>" >
            <table width="100%" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td align="center"><?php if($val['status']=='N'){?>
                  ...
                  <?php }?></td>
                <td align="center"><a href="<?php echo base_url('edit-committee-categtory/'.$val['id']); ?>"><img src="<?php echo image('icons/small/black/edit.png'); ?>"  alt="Edit" title="Edit"></a>
                
                &nbsp;  &nbsp; <a href="<?php echo base_url('del-committee-categtory/'.$val['id']); ?>" onClick="return confirm('Are you sure want to delete?');"><img src="<?php echo image('icons/small/black/delete.png'); ?>"  alt="Delete" title="Delete"></a>
