...
<?php echo js('jquery-1.11.1.min') ?><?php echo js('jquery.min') ?><?php echo js('menu') ?><?php echo css('menu') ?>
...
<?php echo css('reset') ?><?php echo css('admin_style') ?><?php echo css('detail') ?>

<!--[if IE]><script src="http://html5shiv.googlecode.com/svn/trunk/html5.js"></script><![endif]-->

<?php echo js('jquery.ui.core') ?><?php echo js('jquery.ui.widget') ?><?php echo js('jquery.ui.datepicker') ?><?php echo css('plugins') ?>
<script>
...
<?php echo css('popup') ?><?php echo js('script') ?><?php echo js("validation"); ?>
<script>
