...
<div id="MainDiv" class="outer">
  ...
  <div class="gridMainbodyDiv"> 
    ...
    <div class="MainDiv">
        <div class="leftPanel">
          <h1 class="pageTitle">Manage Contacts<a href="<?php echo base_url('export-contact'); ?>" class="button"><span>Export Contacts</span> </a></h1>
          <?php $this->load->view('include/message'); ?>
          <?php echo $pagi; ?>
          <form id="frm_display" method="post" action="<?php echo base_url('manage-contact'); ?>" >
            <table width="100%" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td><input class="sr" type="text" name="FlterData[phone_no]" value="<?php echo $FlterData['phone_no'];?>" /></td>
              ...
              <tr <?php if($val['status']=='N'){echo 'class="unread"';}?>>
                ...
                <td align="center"><a href="view-<?php echo strtolower($form_type);?>/<?php echo $val['id'] ?>"> <img src="<?php echo image('icons/small/black/search.png'); ?>" alt="View" title="View"></a> &nbsp; <a onClick="return confirm('Are you sure want to delete.');" href="del-<?php echo strtolower($form_type);?>/<?php echo $val['id'] ?>"> <img src="<?php echo image('icons/small/black/delete.png'); ?>" alt="Delete" title="Delete"></a></td>
              </tr>
