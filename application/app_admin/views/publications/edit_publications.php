...
<div id="MainDiv" class="outer">
  ...
  <div class="gridMainbodyDiv"> 
    ...
    <div class="MainDiv">
      <div class="leftPanel">
        <h1 class="pageTitle">Edit Publications</h1>
        <div class="From_wrap">
          ...
          <form method="post" action="" name="cms" id="update_form" enctype="multipart/form-data">
            <div class="form_default">
              ...
              <p>
              <label for="product_specifications">Short Descriptions: <span>*</span></label>
             <div class="body">
              <textarea name="short_descriptions" id="bodyContent2"><?php echo $details[0]['short_descriptions']; ?></textarea>
             </div>
            </p>
             ...
             <div class="body">
              <textarea name="descriptions" id="bodyContent2" ><?php echo $details[0]['descriptions']; ?></textarea>
             </div>
            </p>
              ...
              <p>
                ...
                <?php if (file_exists(ABSOLUTE_PATH.'assets/upload/publications/thumb/'.$details[0]['image_name']) && $details[0]['image_name']!='') {?>
                <p><img src="<?php echo get_site_image('upload/publications/thumb').$details[0]['image_name']; ?>" width="100" /></p>
            <?php }?>
            ...
            <?php if (file_exists(ABSOLUTE_PATH.'assets/upload/publications/banner/thumb/'.$details[0]['image_banner']) && $details[0]['image_banner']!='') {?>
                <p><img src="<?php echo get_site_image('upload/publications/banner/thumb').$details[0]['image_banner']; ?>" width="200"  /></p>
            <?php }?>
