...
*/  
 ...
 /* ===============svca==========*/
  ...
  $route['manage-our-member'] = "join_us_member/edit_join_us_member";
  ...
  $route['manage-supportedevents'] = "otherevent/manage_otherevent";
  $route['add-supportedevents'] = "otherevent/add_otherevent";
  $route['edit-supportedevents/(:any)'] = "otherevent/edit_otherevent/$1";
  $route['del-supportedevents/(:any)'] = "otherevent/del_otherevent/$1";
  ...
  ##
  $route['svcareport/(:any)'] = "svcaevent/svcareport/$1";
  ##
