...
class All_function {
	...
	function get_cart_products_list($cart_id) {
        ...
        $get_result = $CI->All_function_model->get_cart_products_list($cart_id);
        return $get_result;
    }
	...
	function get_tools_category_name_row($id) {
        $CI = & get_instance();
        $CI->load->model('All_function_model', '', TRUE);
        $get_result = $CI->All_function_model->get_tools_category_name($id)->row_array();
        return $get_result;
    }
	...
	function get_cart_products_details($cart_id,$products_id) {
        ...
        $result_array = $CI->All_function_model->get_cart_products_details($cart_id,$products_id)->result_array();
        return $result_array;
    }
	...
	function get_parent_tools_category($id) {
        $CI = & get_instance();
        $CI->load->model('All_function_model', '', TRUE);

        $get_result = $CI->All_function_model->get_parent_tools_category($id)->result_array();
        if(isset($get_result[0]['cat_name'])){
		$result = $get_result[0]['cat_name'];
		}else{
			$result = 'Root';
